...
<div class="ui attached menu" >
	...
	<div id="main-wrap" style="height:2600">
		<div id="main-slider">
			<%if(pics_num==1){ %>
			<div class="slide">
		...
		<div class="house-and-owner">
			...
			<div class="house-owner-container">
				...
				<input  type="hidden" value="<%=owner.getUser_id()%>" name="ownerid" id="ownerid" />
					</s:form>
					<a  onclick="document.getElementById('Owner').submit();"><img src="<%=owner.getUser_avatar()%>" />
					</a>
					<div class="owner-info-text">
						<p>
						<a class="owner-name" style="font-size:20px" onclick="document.getElementById('Owner').submit();"><%=owner.getUser_name()%>
						</a> 
						</p>
						<p>
 ...
 <footer  class="ui center aligned  vertical segment m-padded-tb-massive" style="background-color: #e0f3f1;font-family:'微软雅黑'!important;top:430 "><!--vertical 取消圆角不留缝隙 css定义上下宽度-->
