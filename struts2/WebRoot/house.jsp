...
String housetitle = (String)session.getAttribute("houseresult"); 
String ownerid = "1";
...
<%= housetitle%>
   ...
   <s:form action="Owner" theme="simple" method="post" >   
    <div class="column" style="width:100px!important">
    <div class="ui fluid card">
      <div class="image">
        <img src="./avatar/default.jpg">
      </div>
      <div class="attached content"  style="height:50px!important">
   
    <input type="hidden" name="ownerid" value="<%=ownerid%>"/>
    <input  type="submit"  style=" border:none; background-color:white;width:70px;height:25px;font-family:微软雅黑 ;color:#00B5AD;margin-top:0px!important\"value="<%=ownername %>" />
      </div>
    </div>
  </div>
  </s:form>
