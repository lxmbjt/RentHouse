...
document.form1.action="StarModify";
document.form1.submit();
  ...
  <body>
   ...
   <div class="ui attached teal message" style="margin-top:30px ;margin-left:200px ; margin-right:200px ;font-family:'微软雅黑'">
 <i class="star icon"></i> 
...
我的收藏： 
  ...
  <input  type="hidden" value="xxxx" name="deletestar" id="delete" />
   <hr class="style5">
<%=starlist %>
     <br>  
     </s:form>
