...
public class OwnerDAOImpl implements OwnerDAO  {
	...
	public String OwnerHouse(int ownerid) throws Exception{
		...
		String sql = "select * from house where f_owner_id=? && status=0";
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            while(rs.next()){   
                // 查询出内容，之后将查询出的内容赋值给person对象   
    	         ...
    	         String img="<div class=\"ui center aligned divided items\"  ><div class=\"item\"><div class=\"image\" style=\"width:250px;height:158px; \"><img style=\"width:250px;height:160px;\"  src=\""+pic+"\"></div>";
    	         String chargestr="<div class=\"content\"><a class=\"header\" style=\"font-weight:400;margin-bottom:3px;font-family:微软雅黑 ; \">"+title+"</a><div class=\"meta\"><span class=\"price\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:14px;font-weight:bold\">"+charge+"</span>"
    	         +"<span class=\"stay\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:13px;font-weight:bold\" >元/月</span></div>";
    	         String description=" <div class=\"description\"><p>"+city+"  "+add+"</p><p>发布日期："+date+"</p><p>楼层："+storey+"层</p></div>";
    	         String extra="<div class=\"extra\" style=\"font-family:微软雅黑 ;\" ><div class=\"ui label\">"+to+"</div><div class=\"ui label\" >"+renttype+"</div>";
    	         String button=" <input type=\"submit\"   style=\"background-color:#00B5AD;width:70px;height:25.98px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.3em!important;border-bottom-left-radius:0.3em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;\" value=\"详细信息\"id=\""+title+"\"  onclick=\"state(this.id)\" /></div></div></div></div>" ;
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            while(rs.next()){   
                // 查询出内容，之后将查询出的内容赋值给person对象   
    	         ...
    	         System.out.println(pic);
    	         String img="<div class=\"ui center aligned divided items\"  ><div class=\"item\"><div class=\"image\" style=\"width:250px;height:160px; \"><img style=\"width:250px;height:160px;\"  src=\""+pic+"\"></div>";
    	         String chargestr="<div class=\"content\"><a class=\"header\" style=\"font-weight:400;margin-bottom:3px;font-family:微软雅黑 ; \">"+title+"</a><div class=\"meta\"><span class=\"price\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:14px;font-weight:bold\">"+charge+"</span>"
    	         +"<span class=\"stay\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:13px;font-weight:bold\" >元/月</span></div>";
    	         String description=" <div class=\"description\"><p>"+city+"  "+add+"</p><p>发布日期："+date+"</p><p>楼层："+storey+"层</p></div>";
    	         String extra="<div class=\"extra\" style=\"font-family:微软雅黑 ;\" ><div class=\"ui label\">"+to+"</div><div class=\"ui label\" >"+renttype+"</div>";
    	         String button=" <input type=\"submit\"   style=\"background-color:#00B5AD;width:70px;height:25px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.2em!important;border-bottom-left-radius:0.2em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;\""
    	        	+ " value=\"查看修改\"id=\""+id+"\"  onclick=\"state1(this.id)\" />" ;
    	         String button2=" <input type=\"submit\"   style=\"background-color:#00B5AD;width:70px;height:25px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.2em!important;border-bottom-left-radius:0.2em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;\""
     	        	+ " value=\"删除房源\"id=\""+id+"\"  onclick=\"state5(this.id)\" />" ;
    	         String button3="";
    	         if(status==0){
    	          button3=" <input type=\"submit\"   style=\"background-color:#00B5AD;width:70px;height:25px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.2em!important;border-bottom-left-radius:0.2em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;\""
      	        	+ " value=\"下架房源\"id=\""+id+"\"  onclick=\"state6(this.id)\" /></div></div></div></div>" ;
    	         }
    	         else{
    	        	 
    	        button3=" <input type=\"submit\"  class=\"ui label\" id=\""+id+"\"  onclick=\"state7(this.id)\" value=\"重新上架\" style=\"border:2px solid #00B5AD;height:29px\"/>"
    	      	        	+ "</div></div></div></div>" ;
    	         }
    	         String line=" <hr class=\"style5\">";
    	         
    	         str+=img+chargestr+description+extra+button+button2+button3+line;
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            while(rs.next()){   
                // 查询出内容，之后将查询出的内容赋值给person对象   
    	         ...
    	         String description=" <div class=\"description\" style=\"margin-top:15px;font-family:微软雅黑 ;margin-left:20px;\"><p style=\"margin:6px auto;\">预约地点："+position+"</p><p style=\"margin:6px auto;\">预约房主："+"<a id=\""+orderrs.getString("user_id")+"\" onclick=\"order(this.id);\"style=\"text-decoration:underline;color:black\"\">"+ordername+"</a></p><p style=\"margin:6px auto;\">房主电话："+orderphone+"<p style=\"margin:6px auto;\">我的留言："+message+"</p><p style=\"margin:6px auto;\">状态："+agree+button+"</p></div></div></div>" ;
    	         String line=" <hr class=\"style5\">";
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            while(rs.next()){   
                // 查询出内容，之后将查询出的内容赋值给person对象   
    	         ...
    	         String img="<div class=\"ui center aligned  items\"  >";
    	         String chargestr="<div class=\"content\"><a class=\"header\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:22px;margin-left:20px;\">"+date+"</a><span class=\"price\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:16px;\">——"+time+"</span>";
    	         String description=" <div class=\"description\" style=\"margin-top:15px;font-family:微软雅黑 ;margin-left:20px;\"><p style=\"margin:6px auto;\">预约地点："+position+"</p><p style=\"margin:6px auto;\">预约租客："+"<a id=\""+orderrs.getString("user_id")+"\" onclick=\"order(this.id);\"style=\"text-decoration:underline;color:black\"\">"+ordername+"</a></p><p style=\"margin:6px auto;\">租客电话："+orderphone+"<p style=\"margin:6px auto;\">ta的留言："+message+"</p><p style=\"margin:6px auto;\">状态："+agree+button1+button2+"</p></div></div></div>" ;
    	         String line=" <hr class=\"style5\">";
           ...
           // pstmt.setString(1,user.getUsername()) ;  
			...
			while(rs.next()){   
                ...
                // 查询出内容，之后将查询出的内容赋值给person对象   
            	 ...
            	 if(rshouse.next()){
    	         String title = rshouse.getString("housetitle");  
    	         String city=rshouse.getString("city");
    	         ...
    	         String pic=Pic(id);
    	         System.out.println(pic);
    	         String img="<div class=\"ui center aligned divided items\"  ><div class=\"item\"><div class=\"image\" style=\"width:250px;height:158px; \"><img src=\""+pic+"\" style=\"width:250px;height:158px;\" ></div>";
    	         String chargestr="<div class=\"content\"><a class=\"header\" style=\"font-weight:400;margin-bottom:3px;font-family:微软雅黑 ;\">"+title+"</a><div class=\"meta\"><span class=\"price\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:14px;font-weight:bold\">"+charge+"</span>"
    	         +"<span class=\"stay\" style=\"color:#00B5AD ;font-family:微软雅黑 ; font-size:13px;font-weight:bold\" >元/月</span></div>";
    	         String description=" <div class=\"description\"><p>"+city+" "+add+"</p><p>发布日期："+date+"</p><p>楼层："+storey+"层</p></div>";
    	         String extra="<div class=\"extra\" style=\"font-family:微软雅黑 ;\" ><div class=\"ui label\">"+to+"</div><div class=\"ui label\" >"+renttype+"</div>";
    	         ...
    	         String button2=" <input type=\"submit\"   style=\"background-color:#00B5AD;width:70px;height:25px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.2em!important;border-bottom-left-radius:0.2em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;\""
      	        	+ "\" value=\"取消收藏\"id=\""+starid+"\"  onclick=\"return state1(this.id)\" /></div></div></div></div>" ;
     	        String line=" <hr class=\"style5\">";
	...
	public void offhouse(int id) throws Exception {
		String sql = "UPDATE house SET status = 1 WHERE house_id = ?";
        PreparedStatement pstmt = null ;   
        DBConnect dbc = null;   
        try{   
            // 连接数据库   
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            pstmt.executeUpdate();
            pstmt.close() ;  
            System.out.println("off already");   
            } 
