...
public class SearchDAOImpl implements SearchDAO  {
	...
	public String Search(int province,String search,int pageNow) throws Exception{
		...
		String sql = "select * from house where province=? && (housetitle like ? || city like ?) && status=0 limit "+(pageNow*10-10)+","+10  ;
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            while(rs.next()){   
                // 查询出内容，之后将查询出的内容赋值给person对象   
    	         ...
    	         String img="<div class=\"ui center aligned divided items\"  ><div class=\"item\"><div class=\"image\" style=\"width:250px; \" ><img style=\"width:250px; height:160px;\" src=\""+pic+"\"></div>";
    	         ...
    	         String button=" <input  type=\"submit\"   style=\"background-color:#00B5AD;width:70px;height:25.98px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.3em!important;border-bottom-left-radius:0.3em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;"
	...
	public String SearchByTag(int charg,String roomnum,String rent_type,String housetype,String toward,String chargetype,String province, String search) throws Exception{
        ...
        String sql = "select * from house where charge between ? and ? && room_number  like ? &&rent_type like ? && " +
        		"room_type like ? && towards like ? && charge_type like ?&&province=? && (housetitle like ? || city like ?)&&status=0";
           ...
           // pstmt.setString(1,user.getUsername()) ;  
            ...
            while(rs.next()){   
                // 查询出内容，之后将查询出的内容赋值给person对象   
    	         ...
    	         String extra="<div class=\"extra\" style=\"font-family:微软雅黑 ;\" ><div class=\"ui label\">"+to+"</div><div class=\"ui label\" >"+renttype+"</div>";
    	         String button=" <input type=\"submit\"  style=\"background-color:#00B5AD;width:70px;height:25.98px;font-family:微软雅黑 ;color:white;border-width:0px;border-bottom-right-radius:0.3em!important;border-bottom-left-radius:0.3em!important;border-top-right-radius:0.3em!important;border-top-left-radius:0.3em!important;\""
    	        	+" value=\"详细信息\"id=\""+title+"\"  onclick=\"state(this.id)\" /></div></div></div></div>" ;
